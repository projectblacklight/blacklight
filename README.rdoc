...
Instructions for installing the demo app are contained in the plugin's {README.rdoc}[http://github.com/projectblacklight/blacklight/blob/master/README.rdoc]
