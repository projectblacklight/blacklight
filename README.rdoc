...
==Pre-requisites
Whichever method you choose for installation, be sure you have all the pre-requisites in place. You can find these detailed in {PRE-REQUISITES.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.7.0/doc/PRE-REQUISITES.rdoc]

==Installing the demo app
Instructions for installing the demo app are contained in the file  {README_INSTALLATION.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.7.0/doc/README_INSTALLATION.rdoc]

==Installing the plugin into an existing rails app
Instructions for installing the demo app are contained in the plugin's  {README_INSTALLATION.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.7.0/doc/README_INSTALLATION.rdoc]

==Running solr
You'll also want some information about how Blacklight expects Apache SOLR ( http://lucene.apache.org/solr ) to run, which you can find in {README_SOLR.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.7.0/doc/README_SOLR.rdoc]