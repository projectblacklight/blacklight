...
Blacklight no longer provides user authentication or a user model of any sort.  However, Blacklight works out of the box with Devise. Please see https://github.com/plataformatec/devise for more information on Devise.  If you want to just push forward, then just add  "gem 'devise'" to your Gemfile, and execute do the following:
...
Install and configure devise for the test application (see user authentication below for more information)
  $ rails generate devise:install
  $ rails generate devise user
  $ rails generate devise:views

Install and configure blacklight
  $ rails generate blacklight
