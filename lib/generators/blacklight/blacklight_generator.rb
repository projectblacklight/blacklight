...
This generator makes the following changes to your application:
 ...
 7. Copies over public assets, including images, stylesheets, and javascript
...
EOF
  ...
  def copy_migrations
    ...
    migration_template 'migrations/create_searches.rb', 'db/migrate/create_searches.rb'
    migration_template 'migrations/create_bookmarks.rb', 'db/migrate/create_bookmarks.rb'
    migration_template 'migrations/add_authlogic_fields_to_users.rb', 'db/migrate/add_authlogic_fields_to_users.rb'
    migration_template 'migrations/acts_as_taggable_migration.rb', 'db/migrate/acts_as_taggable_migration.rb'
