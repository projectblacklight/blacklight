...
This generator makes the following changes to your application:
 ...
 2. Creates config/solr.yml with a default solr configuration that should work with standard marc records
 3. Creates congig/SolrMarc/... with settings for SolrMarc
 4. Injects behavior into your user model
 5. Creates a blacklight document in your /app/models directory
"""
