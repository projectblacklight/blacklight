...
==Pre-requisites
Whichever method you choose for installation, be sure you have all the pre-requisites in place. You can find these detailed in {PRE-REQUISITES.rdoc}[/projectblacklight/blacklight/blob/master/PRE-REQUISITES_rdoc.html]
...
Instructions for installing the demo app are contained in the plugin's {README.rdoc}[/projectblacklight/blacklight/blob/master/README.rdoc]

==Running solr
You'll also want some information about how Blacklight expects Apache SOLR ( http://lucene.apache.org/solr ) to run, which you can find in {README_SOLR.rdoc}[/projectblacklight/blacklight/blob/master/README_SOLR.rdoc]