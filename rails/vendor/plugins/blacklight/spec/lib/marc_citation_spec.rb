...
describe MarcCitation do
  ...
  describe "to_mla" do
    ...
    it "should format a citation without a 245b field correctly" do
      @record_without_245b.to_mla.should == "Janetzky, Kurt, and Bernhard Brüchle. <u>The Horn.</u> London: Batsford, 1988."
    end
    
    it "should format a citation without any authors correctly" do
      @record_without_authors.to_mla.should == "<u>Final Report to the Honorable John J. Gilligan, Governor.</u> [Columbus: Printed by the State of Ohio, Dept. of Urban Affairs, 1971."
    end
    
    it "should format a citation with 4+ authors correctly" do
      @record_with_4plus_authors.to_mla.should == "Greer, Lowell, et al. <u>Music for Horn.</u> [United States]: Harmonia Mundi USA, 2001."
    end
