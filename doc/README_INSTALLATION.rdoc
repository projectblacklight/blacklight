...
Please see {README_PROJECT.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.5.0/doc/README_PROJECT.rdoc] for main information about this project and plugin.

Please see {PRE-REQUISITES.rdoc}[http://github.com/projectblacklight/blacklight/blob/v2.5.0/doc/PRE-REQUISITES.rdoc] for pre-requisites Blacklight needs.

Please see {README_SOLR.rdoc}[http://github.com/projectblacklight/blacklight/blob/v.2.5.0/doc/README_SOLR.rdoc] for information about setting up and configuring SOLR (http://lucene.apache.org/solr).
...
===Installing Blacklight 2.5 (recommended):
  rails ./blacklight-app -m http://github.com/projectblacklight/blacklight/raw/v.2.5.0/template.rb
