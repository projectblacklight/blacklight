...
The plugin ships with a test data set (initialize it with `git submodule update`). To index this data, first be sure that Solr is running (see steps above). Now run this command to index:
