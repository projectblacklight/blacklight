...
RSpec.describe "Blacklight Guided Search Form" do
  describe "guided search form" do
    before do
      ...
      visit '/catalog/guided?hypothetical_existing_param=true&q=ignore+this+existing+query'
    end
  ...
  describe "prepopulated guided search form" do
    before do
      visit '/catalog/guided?op=must&clause[1][field]=title&clause[1]query=medicine&f_inclusive[language_ssim][]=Tibetan&sort=author'
    end
