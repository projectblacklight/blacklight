...
#=begin
  ...
  describe "unapi" do
    ...
    it "should return an unapi formats list from config[:unapi]" do
      ...
      get :unapi
      response.should be_success
      assigns[:export_formats].should == { :mock => { :content_type => "application/mock" } }
    end
  ...
  describe "email/sms" do
    ...
    describe "sms" do
      it "should give error if no phone number is given" do
        ...
        response.flash[:error].should == "You must enter a recipient's phone number in order to send this message"
      end
