  ...
  describe "index action" do
    ...
    describe "with format :json" do
      ...
      it "should get the documents" do
        docs.size.should == 10
        docs.first.keys.should match_array(["published_display", "author_display", "lc_callnum_display", "pub_date", "subtitle_display", "format", "material_type_display", "title_display", "id", "subject_topic_facet", "language_facet", "score"])
      end
  ...
  describe "show action" do
    ...
    describe "with format :json" do
      it "should get the feed" do
        ...
        json["response"]["document"].keys.should match_array(["author_t", "opensearch_display", "marc_display", "published_display", "author_display", "lc_callnum_display", "title_t", "pub_date", "pub_date_sort", "subtitle_display", "format", "url_suppl_display", "material_type_display", "title_display", "subject_addl_t", "subject_t", "isbn_t", "id", "title_addl_t", "subject_geo_facet", "subject_topic_facet", "author_addl_t", "language_facet", "subtitle_t", "timestamp"])
      end
    end
