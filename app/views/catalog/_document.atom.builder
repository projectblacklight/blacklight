...
xml.entry do
  ...
  # TODO: it seems odd that we need a show presenter on an index view.
  xml << blacklight_config.show.document_presenter_class.new(document, self).link_rel_alternates(unique: true)
