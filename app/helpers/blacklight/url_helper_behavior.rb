...
module Blacklight::UrlHelperBehavior
  ...
  def session_tracking_params document, counter, per_page: search_session['per_page'], search_id: current_search_session&.id
    ...
    if blacklight_config&.track_search_session == 'server'
    ...
    context_method = blacklight_config&.track_search_session == 'client' ? 'get' : 'post'
  ...
  def controller_tracking_method
    return "solr_document_path" if blacklight_config&.track_search_session == 'client'
