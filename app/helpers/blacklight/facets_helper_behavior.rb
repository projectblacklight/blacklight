module Blacklight::FacetsHelperBehavior
  ...
  def render_selected_facet_value(facet_solr_field, item)
    content_tag(:span, render_facet_value(facet_solr_field, item, :suppress_link => true), :class => "selected label") +
      link_to(t('search.facets.selected.remove'), remove_facet_params(facet_solr_field, item.value, params), :class=>"remove")
  end
  ...
  def render_facet_count(num)
    content_tag("span", t('search.facets.count', :number => num), :class => "count") 
  end
